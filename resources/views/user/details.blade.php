                ...
                <div class="MainSection-details-order_content">
                    <div class="MainSection-details-order-user-adress">
                        ...
                        <ul class="MainSection-details-order-user--list">
                            ...
                            <li class="MainSection-details-order-user--text">Nazwisko: {{ $order->user->surname }}</li>
                            <li class="MainSection-details-order-user--text">Adres: {{ $order->user->street }}, {{ $order->user->city }}, {{ $order->user->zip_code }}</li>
                        </ul>
                    </div>
                        ...
                        <div class="MainSection-details-order-content">
                            <ul class="MainSection-details-order-table">
                                <li class="MainSection-details-order-table-row MainSection-details-order-table-cell-header">
                                    <div class="MainSection-details-order-table-cell MainSection-details-order-table--product">Produkt</div>
                                    <div class="MainSection-details-order-table-cell MainSection-details-order-table--count">Ilość</div>
                                    <div class="MainSection-details-order-table-cell MainSection-details-order-table--price">Cena</div>
                                    <div class="MainSection-details-order-table-cell MainSection-details-order-table--date">Data oddania</div>
                                    <div class="MainSection-details-order-table-cell MainSection-details-order-table--status">Status</div>
                                </li>
                                ...
                                <li class="MainSection-details-order-table-row">
                                    ...
                                    <div class="MainSection-details-order-table-cell MainSection-details-order-table--date">
                                        <div class="MainSection-details-order-table-cell-name">Data oddania</div>
