...
@section('content')
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <form action="{{ route('admin.product.update', ['product'=>$product->id]) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <img src="{{ asset('storage/'. $product->photo) }}" height="100px" width="100px" class="float-left">
                    </div>
                </div>
